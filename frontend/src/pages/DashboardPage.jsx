  ...
  return (
    <div className="space-y-6" data-testid="dashboard-page">
      ...
      <section className="dashboard-grid" data-testid="dashboard-charts-grid">
        <article className="panel lg:col-span-7 p-5" data-testid="bankroll-growth-card">
          <h3 className="text-2xl uppercase text-zinc-100">Curva de crescimento da banca</h3>
          <div className="mt-4 h-72" data-testid="bankroll-growth-chart">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={summary.growth_curve}>
                <defs>
        ...
        <article className="panel lg:col-span-5 p-5" data-testid="strategy-profit-card">
          <h3 className="text-2xl uppercase text-zinc-100">Lucro por estratégia</h3>
          <div className="mt-4 h-72" data-testid="strategy-profit-chart">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={summary.profit_by_strategy}>
                <CartesianGrid strokeDasharray="2 2" stroke="#27272a" />
